  ...
  ({ className, logo, slogan, title, subtitle, callToAction, backgroundImage, contactInfo, ...props }, ref) => {
    ...
    return (
      ...
      >
          ...
          <div className="flex flex-col gap-12 lg:gap-16">
            ...
            <div className="flex flex-col gap-8">
              <motion.h1
                ...
                className="font-display tracking-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light leading-[1.02] text-foreground"
              >
                {title}
              </motion.h1>
        ...
        <motion.div
          className="relative w-full lg:w-[45%] min-h-[400px] lg:min-h-0"
